...
Note: Once enabled, requests without authentication information are rejected instead of being treated as Default platform requests.`,
  ...
  "到期": "Expires",
  "已用流量": "Used Traffic",
  "订阅流量": "Subscription traffic",
  "昨日平台总流量": "Yesterday platform traffic",
  "剩余": "Remaining",
  ...
  "租约": "Leases",
  "绑定租约": "Bind Lease",
  "绑定租约 {{account}}": "Bind lease {{account}}",
  "租约名称": "Lease name",
  "点击复制租约名称": "Click to copy lease name",
  "租约名称已复制": "Lease name copied",
  "选择节点": "Select node",
  "选择": "Select",
  "已选择": "Selected",
  "已绑定": "Bound",
  ...
  "确认绑定": "Bind",
  "没有租约": "No leases",
  "正在加载租约数据...": "Loading lease data...",
  "租约 {{account}} 已绑定到 {{ip}}": "Lease {{account}} bound to {{ip}}",
  "租约 {{account}} 已解绑": "Lease {{account}} unbound",
  "确认解绑租约 {{account}}？": "Unbind lease {{account}}?",
  "HTTP": "HTTP",
  ...
  "公开订阅": "Public Subscription",
  "公开订阅链接": "Public Subscription Links",
  "关闭订阅管理": "Close subscription management",
  "使用同一个 Token，按格式参数获取健康节点订阅。":
    "Use one token and choose the output format through the query parameter.",
  "自动识别": "Auto detect",
  "Clash": "Clash",
  "Mihomo": "Mihomo",
  "v2rayN": "v2rayN",
  ...
  "暂无公开订阅链接": "No public subscription URL",
  "确认重置公开订阅 Token？旧链接会立即失效。":
    "Reset the public subscription token? The old URLs will stop working immediately.",
  "公开订阅 Token 已重置": "Public subscription token reset",
  "重置公开 Token": "Reset public token",
  "重置中...": "Resetting...",
  ...
  "节点已清理": "Node cleaned",
  "节点已清理，解除 {{count}} 个绑定": "Node cleaned, released {{count}} bindings",
  ...
  "确认清理节点 {{name}}？该节点会从节点池移除，并解除相关租约。":
    "Clean node {{name}}? It will be removed from the node pool and related leases will be released.",
  "确认清除平台 {{name}} 的所有租约？":
