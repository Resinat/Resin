...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "失败自动重试次数": "Max retries on failure",
  "不能为负数": "Must not be negative",
  "重试 {n} 次": "Retried {n}x",
  "请求经过 {n} 次重试后成功": "Request succeeded after {n} retry attempt(s)",
  "请求经过 {n} 次重试后仍然失败": "Request failed after {n} retry attempt(s)",
  "第 {n} 次尝试": "Attempt #{n}",
  "最终结果": "Final result",
  "节点:": "Node:",
